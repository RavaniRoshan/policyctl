...
// Ruixen Gradient Footer — adapted for Policyctl's heat-orange blueprint design system.
// Its content reads first; the blurred ember glow is pinned to the bottom of the
...
// Policyctl heat gradient stops, floor (0) → top (1):
// deep carbon ember → ruby heat → signature heat orange (#fa5d19) → radiant amber → golden crest → transparent.
export const POLICYCTL_HEAT_STOPS: Stop[] = [
  { offset: 0, color: "#1c0702" },
  { offset: 0.18, color: "#6e1500" },
  { offset: 0.35, color: "#c43806" },
  { offset: 0.52, color: "#fa5d19" },
  { offset: 0.68, color: "#ff8c00" },
  { offset: 0.82, color: "#ffd000" },
  { offset: 0.92, color: "#ffe680" },
  { offset: 1, color: "#fa5d1900" },
];
...
export function RuixenGradientFooter({
  ...
  return (
    ...
    >
      ...
      {/* Glow band: fixed to the viewport */}
      <div
        ref={bandRef}
        aria-hidden
        style={{
