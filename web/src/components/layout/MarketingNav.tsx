    ...
    >
      ...
      <div
        className={`md:hidden overflow-hidden transition-all duration-300 ease-out ${
          mobile ? "max-h-400 opacity-100 border-t border-border-faint" : "max-h-0 opacity-0 border-t border-transparent"
        }`}
      >
        <div className="px-16 py-16 flex flex-col gap-4 bg-background-base">
          ...
          <Link
            to="/signup"
            className="px-12 py-8 rounded-md text-label-large font-medium text-heat-100"
          >
            Get started free →
          </Link>
        </div>
